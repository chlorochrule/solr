 ...
 * For Lucene 9.1 e.g. See {@link org.apache.lucene.codecs.lucene92.Lucene92Codec} Currently {@link
 * org.apache.lucene.backward_codecs.lucene90.Lucene90HnswVectorsFormat} and {@link
 * org.apache.lucene.codecs.lucene92.Lucene92HnswVectorsFormat} are supported for advanced
...
public class DenseVectorField extends FloatPointField {
   ...
   * Lucene92HnswVectorsFormat} format implementations. Controls how many of the nearest neighbor
   * candidates are connected to the new node. Defaults to {@link
   * Lucene92HnswVectorsFormat#DEFAULT_MAX_CONN}. See {@link HnswGraph} for more details.
   */
  private int hnswMaxConn;
  /**
   * This parameter is coupled with the {@link Lucene90HnswVectorsFormat} and {@link
   * Lucene92HnswVectorsFormat} format implementations. The number of candidate neighbors to track
   * while searching the graph for each newly inserted node. Defaults to to {@link
   * Lucene92HnswVectorsFormat#DEFAULT_BEAM_WIDTH}. See {@link HnswGraph} for details.
   */
